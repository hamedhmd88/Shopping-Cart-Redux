...
export const sumPrice = products => {
    return products.reduce((total, product) => total + product.price * product.quantity , 0 ).toFixed(2); //  برای جمع  کردن قیمتهای آیتم های انتخابی و پرایس ضربدر کوانتیتی برای زمانی است که یک کالا چنتا ازش انتخاب میشود و ضربدر تعداد آن میکنیم

};

export const sumQuantity = products => {
    return products.reduce((counter, product) => counter + product.quantity, 0); // برای جمع تعداد آیتم ها
};
